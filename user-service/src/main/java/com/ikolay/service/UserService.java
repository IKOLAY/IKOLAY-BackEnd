...
public class UserService extends ServiceManager<User, Long> {
    ...
    private void testDefaultEmployees() {
        ...
        save(User.builder().authId(6L).salary(200000L).email("aktas@gmail.com").shiftId(1L).firstname("Aktaş").lastname("Sabancı").address("Halkali Caddesi No.198/200 Küçükçekmece İstanbul").password("123").companyEmail("akt.akt@ikolay.com").phone("+905321333667").role(ERole.MANAGER).companyId(1L).status(EStatus.ACTIVE).photoUrl("https://mdbcdn.b-cdn.net/img/new/avatars/22.webp").build());
